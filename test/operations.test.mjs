...
`)
    ...
    assert.match(old.value.data.agent_docs.error, /supported range 1\.27\.8 through 1\.27\.8/)
...
`)
    ...
    assert.match(newer.value.data.agent_docs.error, /supported range 1\.27\.8 through 1\.27\.8/)
...
`)
    ...
    assert.match(oldNils.value.data.agent_docs.error, /supported range 1\.27\.8 through 1\.27\.8/)
...
`)
    ...
    assert.match(previousNils.value.data.agent_docs.error, /supported range 1\.27\.8 through 1\.27\.8/)
...
`)
    ...
    assert.match(retained.value.data.agent_docs.error, /supported range 1\.27\.8 through 1\.27\.8/)
  } finally {
    subject.cleanup()
  }
})
