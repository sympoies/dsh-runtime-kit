...
test('compatibility workflow keeps selected channels and every patch release blocking', () => {
  ...
  assert.match(workflow, /nils-cli-v1\.27\.19-aarch64-apple-darwin\.tar\.gz/)
  assert.match(workflow, /2a78403f0cae739e6b3e9bb550779616170a69514639dfd8ed2e44ab9a7fc63a/)
