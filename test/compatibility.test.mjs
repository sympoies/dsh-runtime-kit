...
test('compatibility workflow keeps selected channels and every patch release blocking', () => {
  ...
  assert.match(workflow, /nils-cli-v1\.27\.32-x86_64-unknown-linux-gnu\.tar\.gz/)
  assert.match(workflow, /db0ef6c888574c0c4e538e96a9a1dfa8f7d23d9beceed7249b90b54061b8918c/)
  assert.match(workflow, /nils-cli-v1\.27\.32-aarch64-apple-darwin\.tar\.gz/)
  assert.match(workflow, /69c1c5e9195c59fdadaa9069a0d6a3908462cef52c79b0934bdf664e0353fc2c/)
  assert.match(workflow, /DSH_ACCEPTANCE_CANDIDATE_NILS_SOURCE_COMMIT=96ee66590428e173c10c494565a3bb429b7b6db8/)
