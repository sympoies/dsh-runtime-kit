...
test('compatibility workflow keeps selected channels and every patch release blocking', () => {
  ...
  assert.match(workflow, /nils-cli-v1\.27\.11-aarch64-apple-darwin\.tar\.gz/)
  assert.match(workflow, /64cbed7372673e10531d14dbe240763168d620fb0d22361a1dde82c375270a23/)
