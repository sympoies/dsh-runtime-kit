...
test('compatibility workflow keeps selected channels and every patch release blocking', () => {
  ...
  assert.match(workflow, /nils-cli-v1\.27\.15-aarch64-apple-darwin\.tar\.gz/)
  assert.match(workflow, /5ac5d7d43b8a4e9fb9f5758b5d371bf14e3658f86292294ca22c62e99a81bc9a/)
