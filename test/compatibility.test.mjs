...
test('compatibility workflow keeps selected channels and every patch release blocking', () => {
  ...
  assert.doesNotMatch(workflow, /nils-cli-v1\.27\.27-/)
  assert.doesNotMatch(workflow, /8c9fc05c37a575e639265ad11608312723d81f8cbaca19452824d995deeee2df/)
  assert.doesNotMatch(workflow, /962877dac23085859f373770c63641b70346f7181c874cf903a1ea6c215b046f/)
