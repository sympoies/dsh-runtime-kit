...
test('compatibility workflow keeps selected channels and every patch release blocking', () => {
  ...
  assert.match(workflow, /DSH_ACCEPTANCE_CANDIDATE_NILS_SOURCE_COMMIT=e6f50a34d68e7a6638eb104e423dcacd116c4071/)
  assert.match(workflow, /DSH_ACCEPTANCE_BASELINE_NILS_SOURCE_COMMIT=1e93e23cdf89cc82eac0e81d796fa13136d3782f/)
  assert.match(workflow, /nils-cli-v1\.27\.27-x86_64-unknown-linux-gnu\.tar\.gz/)
  assert.match(workflow, /8c9fc05c37a575e639265ad11608312723d81f8cbaca19452824d995deeee2df/)
