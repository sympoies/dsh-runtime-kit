...
test('compatibility workflow keeps selected channels and every patch release blocking', () => {
  ...
  assert.match(workflow, /nils-cli-v1\.27\.10-aarch64-apple-darwin\.tar\.gz/)
  assert.match(workflow, /eb0608772760241c65692299e086bb12d1a67e1fe84969009989cae41b996472/)
