...
test('compatibility workflow keeps selected channels and every patch release blocking', () => {
  ...
  assert.match(workflow, /nils-cli-v1\.27\.17-aarch64-apple-darwin\.tar\.gz/)
  assert.match(workflow, /7e772aca9cb01c598d947a283f889248143f15aeeaa1cf6b8aa9e14e38f13a49/)
