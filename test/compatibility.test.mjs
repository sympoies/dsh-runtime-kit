...
test('compatibility workflow keeps selected channels and every patch release blocking', () => {
  ...
  assert.match(workflow, /nils-cli-v1\.27\.12-aarch64-apple-darwin\.tar\.gz/)
  assert.match(workflow, /61c5da6b6e9e6446ce823da2d6cd07708a550052046190c4501e1aac6ac2feb7/)
