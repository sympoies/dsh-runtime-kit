...
test('the patch entry records an optional authenticated upstream reference', async () => {
  ...
  try {
    ...
    for (const reference of [
      ...
      { state: 'reported', url: 'https://localhost/upstream/issues/1' },
      { state: 'reported', url: 'https://127.0.0.1/upstream/issues/1' },
      { state: 'reported', url: 'https://10.1.2.3/upstream/issues/1' },
      { state: 'reported', url: 'https://192.168.1.1/upstream/issues/1' },
      { state: 'reported', url: 'https://172.20.0.1/upstream/issues/1' },
      { state: 'reported', url: 'https://169.254.1.1/upstream/issues/1' },
      { state: 'reported', url: 'https://[::1]/upstream/issues/1' },
      { state: 'reported', url: 'https://forge.internal/upstream/issues/1' },
      [{ state: 'not-reported' }],
      null,
    ]) {
