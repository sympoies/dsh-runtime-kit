...
Seventeen focused tests now pass. Mutations default to dry-run, require an exact
...
The DSH package suite passes 174/174 plus typecheck, the real packed smoke and
