...
- [Session-owned artifacts](artifacts.md) — opaque references, exact-agent
  authorization, atomic streaming commits, retention, export receipts, and
  typed outcomes for generated outputs.
