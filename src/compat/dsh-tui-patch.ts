...
export function validateDshTuiPatchManifest(value: unknown) {
...
async function regularContainedFile(root: string, child: string, label: string) {
...
function execFileWithInput(file: string, args: string[], options: import('node:child_process').ExecFileOptionsWithStringEncoding, input: Buffer) {
...
async function gitApply(gitBin: string, packageRoot: string, args: string[], input: Buffer) {
